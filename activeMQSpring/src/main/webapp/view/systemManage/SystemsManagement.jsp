		...
		<div class="modal-content addMymodal">
			...
			<div class="modal-body text-center">
				<form class="row" id="addInfor">
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>登录名:</span><input type="text" class="validate[required]  form-control inputName" id="loginName" /></div>
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>登录密码:</span><input type="text" class="validate[required] form-control inputName" id="passWord" /></div>
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>姓名:</span><input type="text" class="validate[required] form-control inputName" id="userName" /></div>
					<!-- <div class="col-xs-6 polling"><span class="textWidth LineHeightText">
						<span class="item">*</span>角色:</span>
						<input type="text" class="validate[required] form-control inputName" />
						<div class="select-box select-city inputName text-left">
						    <div class="select-header"> 普通</div>
							    <ul class="select-content">
							      <li>普通</li>
							    </ul>
						 </div>
					</div> -->
					<!-- <div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>Email地址:</span><input type="text" class="validate[required] form-control inputName" id="userName" /></div>
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>手机号:</span><input type="text" class="validate[required] form-control inputName" /></div> -->
				</form>
			</div>
			<div class="modal-footer modalHeaderButtom">
				...
				<button type="button" class="btn btn-primary BtnTop" id="addInforMaTYU">
									              		确定
									            </button>
			</div>
		</div>
		...
		<div class="modal-content addMymodal">
			...
			<div class="modal-body text-center">
				<form class="row" id="addInfor1">
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>登录名:</span><input type="text" class="validate[required]  form-control inputName" id="loginName1" readonly="readonly"/></div>
					<div class="col-xs-6 polling" style="display:none;"><span class="textWidth"><span class="item">*</span>登录密码:</span><input type="text" class="validate[required] form-control inputName" id="passWord1" /></div>
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>姓名:</span><input type="text" class="validate[required] form-control inputName" id="userName1" /></div>
					<!-- <div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>Email地址:</span><input type="text" class="validate[required] form-control inputName" id="userName" /></div>
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>手机号:</span><input type="text" class="validate[required] form-control inputName" /></div> -->
				</form>
			</div>
			...
			<div class="modal-body text-center">
				...
				<form id="YuanMiMaPass" style="margin-top: -18px;margin-bottom: 40px;">
					<div class="pupInfor" id="munAdd">
						<div class="col-xs-12 polling"><span class=""><span class="item">*</span>新密码:</span><input type="text" class="validate[required]  form-control inputName" id="yuanPassword" /></div>
					</div>
				</form>
			</div>
			<div class="modal-footer modalButtom">
				<button type="button" class="btn btn-primary BtnTop data_hiding" data-dismiss="modal">取消
									            </button>
				<button type="button" class="btn btn-primary BtnTop" id="YuanMiMa">
									              		确定
									            </button>
			</div>
		</div>
...
<div class="modal fade " id="addMun" tabindex="-1" role="dialog" aria-labelledby="addMyModal" aria-hidden="true">
	  <div class="modal-dialog">
		<div class="modal-content delecMymodal" style="height:320px;top: 77px;">
			...
			<div class="modal-body text-center ztree" id="roleQuanXian" style="height:230px; overflow: auto;padding-left:114px;">
			</div>
			<div class="modal-footer modalButtom">
				<button type="button" class="btn btn-primary BtnTop" data-dismiss="modal">取消
									            </button>
				<button type="button" class="btn btn-primary BtnTop" id="seveQuanXian">
									              		确定
									            </button>
			</div>
		</div>
		 ...
		 <table style="height:auto;max-height:420px;" data-side-pagination="server" data-response-handler="filterInfor" id="TableList" data-method="post" data-query-params="offetFunction" data-unique-id="loginName" data-striped="true" data-url="<%=basePath%>sys/queryUsers" data-pagination="true" data-click-to-select="true" data-single-select="false" >
		 	<thead>
				<tr>
					...
					<!-- <th data-field="price" data-align="center">手机号</th>
					<th data-field="EMail" data-align="center">E-mail地址</th> -->
			 		...
			 		<!-- <th data-field="createDate" data-align="center">最近一次登录</th> -->
