		...
		<div class="modal-content addMymodal">
			...
			<div class="modal-body text-center">
				<form class="row" id="addInfor">
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>角色名称:</span><input type="text" class="validate[required]  form-control inputName" id="roleName"/></div>
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>角色描述:</span><input type="text" class="validate[required] form-control inputName" id="roleDesc"/></div>
				</form>
			</div>
		...
		<div class="modal-content addMymodal">
			...
			<div class="modal-body text-center">
				<form class="row" id="addInfor1">
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>角色名称:</span><input type="text" class="validate[required]  form-control inputName" id="roleName1"/></div>
					<div class="col-xs-6 polling"><span class="textWidth"><span class="item">*</span>角色描述:</span><input type="text" class="validate[required] form-control inputName" id="roleDesc1"/></div>
				</form>
			</div>
			<div class="modal-footer modalHeaderButtom">
	  ...
	  <div class="modal-dialog">
		<div class="modal-content delecMymodal" style="height:320px;top: 77px;">
			...
			<div class="modal-body text-center">
				...
				<div class="pupInfor">
					<div class="modal-body text-center ztree" id="rolePermission" style="width:290px; height:170px; overflow: auto;">
					</div>
				</div>
			</div>
			<div class="modal-footer modalButtom">
				...
				<button type="button" class="btn btn-primary BtnTop" id="saveRolePermission">
									              		确定
									            </button>
			</div>
		</div>
