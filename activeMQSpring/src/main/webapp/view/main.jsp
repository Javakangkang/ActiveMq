		...
		<div class="modal-content Mymodal">
			...
			<div class="modal-body text-center" style="height:140px;padding-top:8px;position: relative;">
				<form class="row" id="addInfor1" >
					<div class="col-xs-12"><span class="textWidth"><span class="item">*</span>原密码:</span><input type="text" class="validate[required]  form-control inputName"id="macBrand1" /></div>
			...
			<div class="modal-footer modalHeaderButtom">
				...
				<button type="button" class="btn btn-primary modalBtn" id="revisePassword">
									              		确定
									            </button>
			</div>
		</div>
...
function leftMenu(data,index,path){
	...
	$("#revisePassword").click(function(){
		...
		var data = {loginUser:$("#loginInfor").html(),newpwd:$("#macModelwX").val(),pwd:index_1}
		$.ajax({
