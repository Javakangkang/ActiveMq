	...
	<div class="col-xs-12 polling PaddIngMargin">
		<div class="col-xs-12 PaddIngMargin">
			...
			<div class="col-xs-6 PaddIngMargin">
					<label for="dtp_input1" class="col-md-3 control-label" style="margin-top: 6px;width: 90px;">开始日期:</label>
	                <div class="input-group date form_datetime" style="width:200px;">
	                    <input class="form-control" size="16" type="text" value="" id="kaiTime" readonly>
	                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
						<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
	                </div>
					<input type="hidden" id="dtp_input1" value="" /><br/>
				<!-- <input type="text" class="form-control inputName" id=""/> -->
				</div>
		...
		<div class="col-xs-12 PaddIngMargin">
			...
			<div class="PaddIngMargin col-xs-4">
				<label for="dtp_input1" class="col-md-3 control-label" style="margin-top: 6px;width: 90px;">结束日期:</label>
                <div class="input-group date form_datetime1" style="width:200px;">
                    <input class="form-control" size="16" type="text" value=""  id="jieTime" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
...
<div class="col-xs-12 PaddIngMargin">
	<table id="TableList" style="height: auto; max-height: 380px;" data-height="370" data-side-pagination="server" data-method="post" data-query-params="offetFunction" data-unique-id="controlFlow" data-striped="true"
		...
		<thead>
			<tr>
				...
				<th data-width="11%" data-field="controlFlow" data-align="center">流水号</th>
				<th data-width="9%" data-field="deployCode" data-align="center">机器编号</th>
				<th data-width="9%" data-field="macModel" data-align="center">设备型号</th>
				<th data-width="9%" data-field="macBrand" data-align="center">设备品牌</th>
				<th data-width="9%" data-field="unitName" data-align="center">机构名称</th>
				
				 <th data-width="9%" data-field="createDate" data-align="center">登记时间</th> 
				 <th data-width="9%" data-field="errorDesc" data-align="center">异常原因</th> 
				 <th data-width="9%" data-field="updaterTime" data-align="center">处理时间</th> 
				 <th data-width="9%" data-field="updater" data-align="center">处理人</th> 
				 <th data-width="9%" data-field="processStatus" data-align="center" data-formatter="usernameFormatter3">处理状态</th>
				 <th data-width="9%" data-field="processDesc" data-align="center">处理描述</th> 
...
function shangchu(){
	 ...
	 addInfor(data,2,"<%=basePath%>control/processWaring");
}
...
$("#chaxun").click(function(){
	  var data = {macBrand:$("#macBrand").val(),unitName:$("#unitName").val(),startTime:$("#kaiTime").val(),endTime:$("#jieTime").val()};
