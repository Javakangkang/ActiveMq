...
<div class="row contentHeader">
	<div class="col-xs-12 polling PaddIngMargin">
		<div class="col-xs-3 PaddIngMargin">
			<span class="disBlock">设备品牌: </span>
			<input type="text" class="form-control inputName" id="macBrand" placeholder="设备品牌">
		</div>
		<div class="col-xs-3 PaddIngMargin">
			<span class="disBlock">机构名称: </span>
			<input type="text" class="form-control inputName" id="unitName" placeholder="设备名称">
		</div>
		...
		<div class="modal-content addMymodal">
			<div class="row modal-header modalHeaderTop">
				<div class="col-xs-6 text-left modalHeaderTopI">
					<span class="modal-title text-left" id="addMyModal"> 预警处理 </span>
				</div>
...
<div class="col-xs-12 PaddIngMargin">
	<table id="TableList" style="height: auto; max-height: 420px;" data-height="420" data-side-pagination="server" data-method="post" data-query-params="offetFunction" data-unique-id="controlFlow" data-striped="true"
		data-url="<%=basePath%>control/queryWaring" data-pagination="true" data-click-to-select="true" data-single-select="false">
		<thead>
			<tr>
				...
				<th data-width="15%" data-field="controlFlow" data-align="center">流水号</th>
				...
				<th data-width="15%" data-field="caozuo" data-align="center" data-formatter="usernameFormatter">操作</th>
			</tr>
		</thead>
	</table>
</div>
...
//翻译时间
function usernameFormatterFanYi(value,row,index){
