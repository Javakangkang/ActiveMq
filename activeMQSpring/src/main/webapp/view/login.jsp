...
<style>
	...
	.loginImg{width:300px;height:76px;margin: 0 auto;background: url(../images/common/bukongImg.png) no-repeat;background-size:100% 100%;}
                ...
                $.ajax({
                    ...
                    success:function(data){ 
                    	...
                    	if(data.success== true){
                           // busGoto("");
                            location.href = "main.jsp?loginName="+loginName+"&pwd="+passWord+"";
        				}else{
